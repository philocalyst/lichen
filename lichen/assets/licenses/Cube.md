{{#if placeholder0}}{{placeholder0}}{{else}}Copyright (C) 2001-2003 Wouter van Oortmerssen.{{/if}}
...
* {{#if placeholder4}}{{placeholder4}}{{else}}4.{{/if}} Source versions may not be &quot;relicensed&quot; under a different license without my explicitly written permission.
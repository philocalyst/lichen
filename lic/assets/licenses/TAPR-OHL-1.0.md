{{#if placeholder0}}{{placeholder0}}{{else}}Copyright 2007 TAPR - http://www.tapr.org/OHL{{/if}}
...
* {{#if placeholder9}}{{placeholder9}}{{else}}*{{/if}} If you create a design that you want to license under the OHL, you
  should:

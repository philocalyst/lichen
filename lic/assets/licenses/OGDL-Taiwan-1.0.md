...
* {{#if placeholder0}}{{placeholder0}}{{else}}1.{{/if}} Definition
  * {{#if placeholder1}}{{placeholder1}}{{else}}1.1.{{/if}} &quot;Data Providing Organization&quot; refers to government agency, government-owned business, public school and administrative legal entity that has various types of electronic data released to the public under the License when it is obtained or made in the scope of performance for public duties.
  * {{#if placeholder2}}{{placeholder2}}{{else}}1.2.{{/if}} &quot;User&quot; refers to individual, legal entity or group that receives and uses Open Data under the License, including individual, legal entity or group who is receiving and using Open Data as the recipient of the former Users under the sublicensing scenario.
  * {{#if placeholder3}}{{placeholder3}}{{else}}1.3.{{/if}} &quot;Open Data&quot; means data that the Data Providing Organization owns its copyright in whole or has full authority to provide it to third parties in sublicensing way, and provides it in an open and modifiable form such that there are no unnecessary technological obstacles to the performance of the licensed rights, including but not limited to the following creation protected by copyright:
    * {{#if placeholder4}}{{placeholder4}}{{else}}a.{{/if}} &quot;Compilation Work&quot; means a work formed by the creative selection and arrangement of data, and can be protected by copyright law, such as database or other qualified structured data combination.
    * {{#if placeholder5}}{{placeholder5}}{{else}}b.{{/if}} &quot;Material&quot; means a separate work, that is collected into the Open Data aggregation and can be protected by copyright law independently.
...
* {{#if placeholder23}}{{placeholder23}}{{else}}6.{{/if}} Disclaimer
